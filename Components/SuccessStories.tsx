    ...
    <section id="stories" className="relative py-20 px-4 max-w-7xl mx-auto overflow-hidden">
      ...
      <div className="grid md:grid-cols-3 gap-8">
        {testimonials.map((story, i) => (
          <div key={i} className="bg-[#17052b] border-4 border-[#963fdb] rounded-[2rem] p-8 shadow-[8px_8px_0px_0px_rgba(70,4,88,1)] flex flex-col gap-6 relative hover:-translate-y-1 transition-transform">
