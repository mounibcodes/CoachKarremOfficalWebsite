  ...
  return (
    <nav className="fixed top-6 left-0 right-0 z-50 flex justify-center px-4">
      <div className="bg-white border-2 border-black rounded-full px-8 py-4 flex items-center gap-8 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
        ...
        <Link 
          href="/Contact" 
          className="bg-black text-white px-6 py-2 rounded-full font-bold uppercase text-sm border-2 border-transparent hover:bg-white hover:text-black hover:border-black transition-all active:scale-95 hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]"
        >
          Start Now
        </Link>
      </div>
