  ...
  return (
    <section id="about" className="relative py-20 px-4 max-w-7xl mx-auto flex flex-col gap-20 overflow-hidden">
      ...
      <div className="grid md:grid-cols-3 gap-8">
        {/* Card 1 */}
        <div className="bg-[#17052b] border-4 border-[#963fdb] rounded-3xl p-8 shadow-[8px_8px_0px_0px_rgba(70,4,88,1)] hover:translate-y-[-4px] hover:shadow-[12px_12px_0px_0px_rgba(70,4,88,1)] transition-all flex flex-col gap-4">
        ...
        {/* Card 2 */}
        <div className="bg-[#17052b] text-white border-4 border-[#963fdb] rounded-3xl p-8 shadow-[8px_8px_0px_0px_rgba(70,4,88,0.5)] hover:translate-y-[-4px] hover:shadow-[12px_12px_0px_0px_rgba(70,4,88,0.8)] transition-all flex flex-col gap-4">
          <div className="w-12 h-12 bg-[#f3e8ff] rounded-full flex items-center justify-center text-[#17052b] mb-2">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-6 h-6">
