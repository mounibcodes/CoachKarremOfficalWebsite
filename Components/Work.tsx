    ...
    <section id="work" className="relative py-20 px-4 max-w-7xl mx-auto overflow-hidden">
      ...
      <div className="grid md:grid-cols-3 gap-8">
        {projects.map((project, i) => (
          <div key={i} className="group relative aspect-[9/16] bg-[#17052b] border-2 border-[#963fdb]/10 rounded-[2rem] overflow-hidden hover:border-[#963fdb] transition-all hover:shadow-[0px_0px_30px_0px_rgba(147,51,234,0.3)] hover:-translate-y-2">
