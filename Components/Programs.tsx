  ...
  return (
    <section id="programs" className="relative py-20 px-4 max-w-7xl mx-auto flex flex-col gap-16 overflow-hidden">
      ...
      <div className="grid md:grid-cols-3 gap-8 items-start">
        ...
        <div className="bg-[#17052b] border-4 border-[#963fdb] rounded-[2.5rem] p-8 shadow-[8px_8px_0px_0px_rgba(70,4,88,1)] hover:translate-y-[-4px] hover:shadow-[12px_12px_0px_0px_rgba(70,4,88,1)] transition-all flex flex-col gap-6 relative">
        ...
        <div className="bg-[#17052b] text-white border-4 border-[#963fdb] rounded-[2.5rem] p-8 shadow-[12px_12px_0px_0px_rgba(70,4,88,0.5)] hover:translate-y-[-4px] hover:shadow-[16px_16px_0px_0px_rgba(70,4,88,0.8)] transition-all flex flex-col gap-6 relative scale-105 z-10">
